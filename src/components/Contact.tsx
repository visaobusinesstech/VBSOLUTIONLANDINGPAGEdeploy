        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-blue-500/30 text-white p-6 rounded-xl">
              ...
              <button onClick={() => openWhatsApp()} className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 hover:scale-105 font-satoshi">
                💬 Chame no WhatsApp
              </button>
            </div>
          </div>
